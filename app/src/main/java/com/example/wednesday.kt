...
class wednesday : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_wednesday, container, false)
        add = view.findViewById(R.id.imgwed)
        layout = view.findViewById(R.id.containerwednesday)
        buildDialog()
